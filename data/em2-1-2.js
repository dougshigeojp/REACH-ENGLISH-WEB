...
window.initLesson({
    ...
    steps: [
        ...
        // ======================================================
        {
            ...
            dialogue: [
                ...
                { 
                    speaker: "Albert", 
                    text: "I know. [However](tooltip:however), it could make life way easier for everyone. If we [had](tooltip:had) robot-companions at home today, life [would be](tooltip:would-be) much more comfortable, wouldn't it?" 
                },
                { 
                    speaker: "Celine", 
                    text: "[On the other hand](tooltip:on the other hand), it might be dangerous. If scientists [hadn't created](tooltip:hadnt-created) the laws, we [would have had](tooltip:would have had) many more problems with safety by now!" 
                },
                { 
                    speaker: "Albert", 
                ...
                { 
                    speaker: "Albert", 
                    text: "That's a deep question! [Shall](tooltip:shall) we [discuss](tooltip:discuss) this with the teacher?" 
                }
            ]
        },
    ...
    topic: "Context", 
    term: "turn-on", 
    definition: "To start or activate a machine or device.", 
    translation: "Ligar / Acionar" 
},
{ 
    topic: "Context", 
    term: "would-have-had", 
    definition: "Grammar: Conditional Perfect structure, indicating a hypothetical past result.", 
    translation: "Teria tido" 
},
        ...
        { topic: "Context/Expressions", term: "algorithm", definition: "A process or set of rules to be followed in calculations.", translation: "Algoritmo" },
        { topic: "Context/Expressions", term: "automation", definition: "The use of automatic equipment in a production process.", translation: "Automação" },
        { topic: "Context/Expressions", term: "robot", definition: "A machine capable of carrying out a complex series of actions automatically.", translation: "Robô" },
        { topic: "Context/Expressions", term: "software", definition: "The programs and other operating information used by a computer.", translation: "Software" },
        { topic: "Context/Expressions", term: "hardware", definition: "The physical components of a computer system.", translation: "Hardware" },
        { topic: "Context/Expressions", term: "data", definition: "Facts and statistics collected together for reference or analysis.", translation: "Dados" },
        { topic: "Context/Expressions", term: "innovation", definition: "A new method, idea, or product.", translation: "Inovação" },
        { topic: "Context/Expressions", term: "technological-advance", definition: "Progress and innovation within the field of technology.", translation: "Avanço tecnológico" },
        { topic: "Context/Expressions", term: "virtual-reality", definition: "The computer-generated simulation of a three-dimensional image or environment.", translation: "Realidade virtual" },
        { topic: "Context/Expressions", term: "advancement", definition: "An act of moving forward in a process or the state of being advanced.", translation: "Avanço" },
        { topic: "Context/Expressions", term: "If this happens, then that happens", definition: "Used for general truths: If + Present Simple, Present Simple.", translation: "Se isso acontece, então aquilo acontece" },
        { topic: "Context/Expressions", term: "On the other hand", definition: "Used to present an alternative or contrasting point of view.", translation: "Por outro lado" },
        ...
        { topic: "Context/Expressions", term: "Zero Conditional", definition: "Grammar used for general truths: If + Present Simple, Present Simple.", translation: "Condicional Zero" },
        ...
        { topic: "Links/Auxiliaries", term: "Could there be?", definition: "Question used to discuss possibilities in hypothetical scenarios.", translation: "Poderia haver?" },
        { topic: "Links/Auxiliaries", term: "Do you think if...?", definition: "Question structure used to ask for an opinion on a conditional result.", translation: "Você acha que se...?" },
        { topic: "Links/Auxiliaries", term: "First Conditional", definition: "Grammar used for real future possibilities: If + Present, Will + Verb.", translation: "Primeira Condicional" },
        ...
        { topic: "Grammar/Conditionals", term: "Three Laws of Robotics", definition: "A set of rules devised by Isaac Asimov to ensure robot safety.", translation: "Três Leis da Robótica" },
